...
def word_frequency_charts(text, include_others=True, n=10):
  ...
  plt.title('Rozkład częstości słów (słupkowy)')
  plt.xticks(rotation=45)

  plt.tight_layout()
  plt.show()

word_frequency_charts("""
...
# word_frequency_charts("kot kot kot kot kot mama mama mama dom dom lala", True, 2)