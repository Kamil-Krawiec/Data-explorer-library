Welcome to Data-Explorer’s Documentation!
=========================================

**Data-Explorer** is an open-source Python library designed to streamline your workflow in:
- Analyzing datasets and extracting key insights,
- Generating thorough reports on both numeric and categorical features,
- Performing pre-analysis tasks like outlier detection and data distribution visualization,
- Conducting text analysis, such as word frequency and word clouds.
